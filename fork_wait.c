/*Write a C program to create a new process using Fork Operation.Make the parent Processto wait until
 child process Terminates  .Once the child Terminates collect exit status and prin the exit status of the
 child in the parent process using WEXITSTATUS macro.*/
